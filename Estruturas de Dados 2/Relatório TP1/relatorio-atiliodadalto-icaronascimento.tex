...
\renewcommand\theadset{\def\arraystretch{1.85}}%
%%% Definição de variáveis. %%%
% ---
% Informações de dados para CAPA e FOLHA DE ROSTO
% ---
\titulo{Agrupamento baseado em árvores geradoras mínimas}
\autor{Atílio Antônio Dadalto \\ João Felipe Gobeti Calenzani \\ Vitor Ferraz Matos Brunoro}
\local{Vitória}
\data{2020}
\instituicao{%
...
\preambulo{Relatório apresentado como requisito parcial para aprovação na disciplina de Estrutura de Dados II, pela Universidade Federal do Espírito Santo.}
