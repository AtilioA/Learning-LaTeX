...
\begin{center}
    ...
    \begin{tabular}{l l l l}
        ...
        existe       & $\exists$ & \reflectbox{$\exists$} & \LARGE{$\sqcup$}  \\ \hline
    \end{tabular}
\end{center}
...
\begin{enumerate}[label=\arabic*)]
    ...
    \begin{enumerate}[label={\textbf{--}}]
        ...
        A partir do enunciado p(x) formamos \bm{$\{ x / p(x) \}$}, i.e., a coleção dos objetos que satisfazem ao enunciado \textbf{p(x)}.
    \end{enumerate}
...
% Aqui poderia ter-se usado \label nos itens acima e \ref abaixo
