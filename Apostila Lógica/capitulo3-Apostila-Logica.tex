...
\begin{exemplo}
    Uma interpretação para a fórmula \bm{$p \to (q \lor r)$} consiste em atribuir valores lógicos a seus componentes atômicos p, q e r.
\end{exemplo}
\noindent
...
\begin{center}
    ...
    \end{tabular}
\end{center}
que para as interpretações $I_3$ e $I_4$ em que \bm{$p \to q$} e \bm{$p \to \sim q$} são verdadeiras, \bm{$\sim p$} é também verdadeira.
