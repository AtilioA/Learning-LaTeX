...
\bigskip
\noindent
\textbf{Ex. 1.} Jorge Amado é escritor.
...
\bigskip
\noindent
\textbf{Ex. 2.} João é professor de Pascal.
...
\bigskip
\noindent
\textbf{Ex. 3.} Ricardo estuda Inteligência Artificial.
...
\bigskip
\noindent
\textbf{Ex. 4.} Maurício Gugelmin ganhou o campeonato e Nelson Piquet sofreu um acidente
...
\bigskip
\noindent
\textbf{Ex. 5.} O Internacional perderá o campeonato se empatar ou perder para o Flamengo.
...
\bigskip
\noindent
\textbf{Ex. 6.} Certos cursos de programação são interessantes.
...
\bigskip
\noindent
\textbf{Ex. 7.} Todo professor que ensina Inteligência Artificial trabalha com linguagem natural.
...
\begin{enumerate}[label=(\roman*)]
    ...
    T(x, linguagme natural): x trabalha com linguagem natural.
\end{enumerate}

\bigskip
\noindent
\textbf{Ex. 8.} Nenhum motorista é imprudente.
...
\bigskip
\noindent
\textbf{Ex. 9.} Nem todo professor é mestre.
...
\bigskip
\noindent
\textbf{Ex. 10.} Não há um maior número natural.
...
\bigskip
\noindent
\textbf{Ex. 11.} Há no máximo um natural negativo.
...
\bigskip
\noindent
\textbf{Ex. 12.} Há no mínimo uma universidade federal.
...
\bigskip
\noindent
\textbf{Ex. 13.} Existe um único corredor de Fórmula 1 tricampeão do mundo.
...
\bigskip
\noindent
\textbf{Ex. 14.} A coleção dos alunos do 2º grau.
...
\bigskip
\noindent
\textbf{Ex. 15.} O número natural que é par e primo.

% Não consigo fazer esse símbolo de trabalho (tau) (???)
\begin{enumerate}[label=(\roman*)]
...
\bigskip
\noindent
\textbf{Ex. 16.} O aluno da turma 1002.
