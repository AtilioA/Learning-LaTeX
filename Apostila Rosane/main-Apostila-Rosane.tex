...
%% A FAZER %%
% Terminar o capítulo 3 (seções sobre FNC e FND)
% Todo o capítulo 2 (majoritariamente tabelas e transcrição)
% Todo o capítulo 4 (majoritariamente listas e transcrição)
% Um diagrama de um exemplo do capítulo 5
% Revisar capítulos feitos (ainda não)
...
\input{capitulo4-Apostila-Rosane.tex}
\input{capitulo5-Apostila-Rosane.tex}
\input{capitulo6-Apostila-Rosane.tex}
