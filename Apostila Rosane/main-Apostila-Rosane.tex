...
% Criar ambiente\grupo para textos mais recuados \hskip
% Criar ambiente\grupo para os exemplos
...
\usepackage{lipsum}
\usepackage{amsmath}
% \usepackage{mathabx} % Conflita com amsmath mas tem símbolos melhores
